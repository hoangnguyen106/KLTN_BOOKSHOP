...
export const getBook = () => async (dispatch, getState) => {
    let res
    try {
        res = await axios.post('http://localhost:3030/book/allbook', {
...
export const deleteBook = (id) => async(dispatch, getState) => {
    let res
    try {
        res = await axios.get('http://localhost:3030/admin/deletebook/' +id)
    }
    catch (err) {
        console.log(err)
        return
...
export const deleteCategory = (id) => async(dispatch, getState) => {
    let res
    try {
        res = await axios.get('http://localhost:3030/admin/deletecategory/' +id)
    }
    catch (err) {
        console.log(err)
        return
...
export const getCategory = () => async (dispatch, getState) =>  {
    let res
    try {
        res = await axios.get('http://localhost:3030/category/all/' + getState().bookReducers.category.page)
    }
    catch (err) {
        return
    }
...
export const getPublisher = () => async (dispatch, getState) => {
    let res
    try {
        res = await axios.get('http://localhost:3030/publisher/all/' + getState().bookReducers.publisher.page)
    }
    catch (err) {
        return
    }
...
export const deletePublisher = (id) => async(dispatch, getState) => {
    let res
    try {
        res = await axios.get('http://localhost:3030/admin/deletepublisher/' +id)
    }
    catch (err) {
        console.log(err)
        return
...
export const getAuthor = () => async (dispatch, getState) => {
    let res
    try {
        res = await axios.get('http://localhost:3030/author/all/' + getState().bookReducers.author.page)
    }
    catch(err) {
        return
    }
...
export const deleteAuthor = (id) => async(dispatch, getState) => {
    let res
    try {
        res = await axios.get('http://localhost:3030/admin/deleteauthor/' +id)
    }
    catch (err) {
        console.log(err)
        return
...
export const addCategory =  (name) => async (dispatch, getState) => {
    ...
    let res
    try {
        res = await axios.post('http://localhost:3030/admin/addcategory', {
            name: name
        })
    }
    catch(err) {
...
export const updateCategory =  (id, name) => async (dispatch, getState) => {
    let res
    try {
        res = await axios.post('http://localhost:3030/admin/updatecategory', {
            id: id,
            name: name
        })
    }
...
export const addAuthor =  (name) => async (dispatch, getState) => {
    ...
    let res
    try {
        res = await axios.post('http://localhost:3030/admin/addauthor', {
            name: name
        })
    }
    catch(err) {
...
export const updateAuthor =  (id, name) => async (dispatch, getState) => {
    let res
    try {
        res = await axios.post('http://localhost:3030/admin/updateauthor', {
            id: id,
            name: name
        })
    }
...
export const addPublisher =  (name) => async (dispatch, getState) => {
    ...
    let res
    try {
        res = await axios.post('http://localhost:3030/admin/addpublisher', {
            name: name
        })
    }
    catch(err) {
...
export const updatePublisher =  (id, name) => async (dispatch, getState) => {
    let res
    try {
        res = await axios.post('http://localhost:3030/admin/updatepublisher', {
            id: id,
            name: name
        })
    }
...
export const addBook = (id_category, name, price, release_date, describe, id_publisher, id_author, file) =>
 async (dispatch, getState) => {
    ...
    data.append('id_publisher', id_publisher)
    data.append('id_author', id_author)
    let res
    try {
        res = await axios.post('http://localhost:3030/admin/addbook', data)
    }
    catch(err) {
...
export const updateBook = (id, name, id_category, price, release_date, describe, id_publisher, id_author, file) => async (dispatch, getState) => {
    let data = new FormData()
    data.append('file', file)
    data.append('id', id)
    data.append('id_category', id_category) 
    ...
    let res
    try {
        res = await axios.post('http://localhost:3030/admin/updatebook', data)
    }
    catch(err) {
...
export const updateIssend = (name,id) => async (dispatch, getState) => {
    ...
    try {
        ...
        res = await axios.post('http://localhost:3030/bill/updateissend', {
        name: name,
        id:id
        })
    }
