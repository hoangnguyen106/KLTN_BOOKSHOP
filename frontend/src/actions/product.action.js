...
export const getBookDetail = (id) => async (dispatch, getState) => {
    let res
    try {
        res = await axios.get('http://localhost:3030/book/' + id)
    }
    catch (err) {
        return
    }
...
export const getBookRelated = (id) => async (dispatch, getState) => {
    let res
    try {
        res = await axios.get('http://localhost:3030/book/related/' + id)
    }
    catch (err) {
        return
    }
...
export const getNameCategoryByID = (id) => async (dispatch) => {
    let res
    try {
        res = await axios.get('http://localhost:3030/category/name/' + id)
    }
    catch (err) {
        return
    }
...
export const getNamePubliserByID = (id) => async (dispatch) => {
    let res
    try {
        res = await axios.get('http://localhost:3030/publisher/name/' + id)
    }
    catch (err) {
        return
    }
...
export const getNameAuthorByID = (id) => async (dispatch) => {
    let res
    try {
        res = await axios.get('http://localhost:3030/author/name/' + id)
    }
    catch (err) {
        return
    }
...
export const submitComment = (name, email, comment, id_book) => async (dispatch, getState) => {
    ...
    let res
    try {
        res = await axios.post('http://localhost:3030/comment', {
            id_user: id,
            id_book: id_book,
            name: name,
            comment: comment
...
export const getCommentByIDBook = (id) => async (dispatch, getState) => {
    let res
    try {
        res = await axios.post('http://localhost:3030/comment/book', {
            id_book: id,
...
export const addToCart = (product) => async (dispatch, getState) => {
    if (getState().userReducers.login.islogin) {
        let res
        try {
            res = await axios.post('http://localhost:3030/cart/addtocard', {
