...
exports.addBook = async (req, res) => {
    ...
    const {id_category, name, price, release_date, describe, id_publisher, id_author} = req.body;
...
exports.login = async (req, res) => {
    ...
    let token = jwt.sign({email: email,  iat: Math.floor(Date.now() / 1000) - 60 * 30}, process.env.ACCESS_TOKEN_SECRET);
